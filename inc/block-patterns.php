...
if ( function_exists( 'register_block_pattern' ) ) {
	...
	register_block_pattern(
		...
		array(
			...
			'categories'    => array( 'twentytwentyone' ),
			'viewportWidth' => 1440,
			'description'   => _x( 'A Media & Text block with a big image on the left and an heading on the right. The heading is followed by a separator and a description paragraph.', 'Block pattern description', 'twentytwentyone' ),
