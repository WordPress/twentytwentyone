...
if ( function_exists( 'register_block_pattern' ) ) {
	...
	register_block_pattern(
		...
		array(
			...
			'content'       => '<!-- wp:gallery {"ids":[1864,1862,1863],"columns":2,"imageCrop":false,"sizeSlug":"full","align":"wide","className":"is-style-twentytwentyone-overlapping-gallery"} --><figure class="wp-block-gallery alignwide columns-2  is-style-twentytwentyone-overlapping-gallery"><ul class="blocks-gallery-grid"><li class="blocks-gallery-item"><figure><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/the_smoker.png" alt="" data-id="1864" data-full-url="' . esc_url( get_template_directory_uri() ) . '/assets/images/the_smoker.png" data-link="https://gutenberg.test/?attachment_id=1864" class="wp-image-1864"/></figure></li><li class="blocks-gallery-item"><figure><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/girl_in_white.png" alt="" data-id="1862" data-full-url="' . esc_url( get_template_directory_uri() ) . '/assets/images/girl_in_white.png" data-link="https://gutenberg.test/?attachment_id=1862" class="wp-image-1862"/></figure></li><li class="blocks-gallery-item"><figure><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/irises.png" alt="" data-id="1863" data-full-url="' . esc_url( get_template_directory_uri() ) . '/assets/images/irises.png" data-link="https://gutenberg.test/?attachment_id=1863" class="wp-image-1863"/></figure></li></ul></figure><!-- /wp:gallery -->',
		)
	);
}
